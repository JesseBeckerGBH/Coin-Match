...
class MathCandidate(Base):
    ...
    math_family = Column(String(100), nullable=True)
    ...
    novelty_class = Column(String(50), default="unknown")
...
class ExperimentRun(Base):
    ...
    __table_args__ = (Index("ix_experiment_runs_candidate_id", "candidate_id"),)
...
class PromotionDecision(Base):
    ...
    __table_args__ = (Index("ix_promotion_decisions_candidate_id", "candidate_id"),)
